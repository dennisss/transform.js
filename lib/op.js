...
/**
 * @class Operation
 * @classdesc A base class for representing commands to be executed on documents
 *
 */
...
/**
 * Change the current operation, given that the passed operations happen before it
 *
 * @param other a single operation or an array of operations (in order of inclusion) to use to modify the current op
 * @return a version of the current operation with the operations included
 */
